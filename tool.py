...
def is_valid(board):
    ...
    Returns:
        - True, None if board was valid
        - False, reason if board was invalid, where reason is a string
    """
    ...
    try:
        ...
        return False, "last three lines must be valid integers"
